...
import 'category_input_model.dart';
export 'category_input_model.dart';

class CategoryInputWidget extends StatefulWidget {
  const CategoryInputWidget({Key? key}) : super(key: key);
...
class _CategoryInputWidgetState extends State<CategoryInputWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryInputModel());
                          ...
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Want to add this category?'),
                                    actions: [
                                      TextButton(
